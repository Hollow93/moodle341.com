 ...
 *
 *  hollow has evolved over the years as the Moodle core has integrated the many
 *  of the features that have made hollow so popular, including custom menu and
 *  user menu.
 *
 ...
 *  found at https://moodle.org/plugins/view.php?plugin=theme_hollow
 *
 *  Licenses
 *  ------------------------------------------------------------------------------
 ...
 */
 ...
 - (2016081800) Fixed Undefined variable: html in hollow/layout/header.php
 ...
 - (2016080500) Removed z-index for Assignment PDF editor from hollow.css
 - (2016080500) Updated Fontawesome to 4.6.3
 - (2016080500) Updated hollow/lib.php
 - (2016080500) Updated hollow/settings.php
 - (2016080500) Updated hollow/version.php
 - (2016080500) Created new branch - hollow_31_STABLE
 ...
 -  Renamed style/custom.css to style/hollow.css.
 -  Updated hollow/lib.php.
 -  Updated hollow/settings.php.
 -  Validated all CSS stylesheets with W3C CSS Validator (http://jigsaw.w3.org/css-validator/)
 -  Updated hollow/version.php
 -  Created new branch - hollow_30_STABLE
